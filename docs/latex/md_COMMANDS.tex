...
\item {\ttfamily data\+\_\+hazard\+\_\+mode} (string) \+: {\ttfamily ideal} $\vert$ {\ttfamily stall} $\vert$ {\ttfamily forwarding} \+: (multi\+\_\+stage only) Sets the data hazard resolution mode.
\item {\ttfamily branch\+\_\+predictor} (string) \+: {\ttfamily static\+\_\+not\+\_\+taken} $\vert$ {\ttfamily static\+\_\+taken} $\vert$ {\ttfamily dynamic\+\_\+1bit} $\vert$ {\ttfamily dynamic\+\_\+2bit} \+: (multi\+\_\+stage only) Sets the branch prediction mode.
\item {\ttfamily branch\+\_\+stage} (string) \+: {\ttfamily ex} $\vert$ {\ttfamily id} \+: (multi\+\_\+stage only) Sets the pipeline stage where branch comparison occurs.
