...
def format_test_file(preamble_lines, test_lines):
    """
    Wraps instruction lists in a valid .s file format.
...
def main():
    if os.path.exists(BASE_DIR):
        ...
        print("For a clean test, please delete 'assembly_hazard_free' and 'reference_artifacts' first.")
    else:
