/**
* @file rv5s_id_vm.h
* @brief Definition of the 5-stage pipelined RISC-V VM where Branch Comparison happens in the ID stage
*/
...
#define RV5S_ID_VM_H
    ...
    class RV5SIDVM : public VmBase {
        public: 
            explicit RV5SIDVM(bool silent = false);
            ~RV5SIDVM();
        ...
        private: 
            ...
            uint64_t getForwardedIdReg(uint8_t reg_index);  // to forward data in case of branches
    };
    #endif